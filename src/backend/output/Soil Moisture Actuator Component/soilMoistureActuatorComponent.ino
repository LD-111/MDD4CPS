...
void setup() {
    ...
    // Listener Topics(Receiver)
    mqttSetup(soilMoistureData_ListenerThreadMqttClient, callback_soilMoistureData_ListenerThread);
...
void callback_soilMoistureData_ListenerThread(char* topic, byte* payload, unsigned int length) {
